...
| **Progress Narration** | During multi-step operations (3+ tool calls, op > 30s, error/abort, > 60s silent) | Inline to user (1-2 line ticks, see `lib/progress-narration.md`) |
